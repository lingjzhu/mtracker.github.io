...
path_to_train_y = './data/train_y_2'
path_to_validation_x = './data/validation_x'
path_to_validation_y = './data/validation_y_2'
...
#    loss = 'dice'
    ...
    dense = DenseNet.DenseUnet_v2(weights=None,input_shape=input_size,loss = loss)
    ...
    tb = TensorBoard(log_dir=path_to_tensorboard, batch_size=batch_size)
    dense.fit_generator(
